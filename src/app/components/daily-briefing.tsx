                ...
                <div style={{ direction: 'ltr' }} className="h-[110px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={WEEKLY_ACTIVITY_DATA} barGap={2}>
                      ...
                      <Bar key="bar-messages" dataKey="messages" name="پیام" fill="#9B59B6" radius={[4, 4, 0, 0]} barSize={11} isAnimationActive={false} />
                      <Bar key="bar-calls" dataKey="calls" name="تماس" fill="#EC4899" radius={[4, 4, 0, 0]} barSize={11} isAnimationActive={false} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div style={{ direction: 'ltr' }} className="h-[90px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={MONTHLY_REVENUE_DATA.slice(-6)}>
                      <defs>
                        <linearGradient id="briefGradUniq" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <Area key="area-income" type="monotone" dataKey="income" name="درآمد" stroke="#10b981" fill="url(#briefGradUniq)" strokeWidth={2} isAnimationActive={false} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
